...
const Navigation = () => {
  ...
  return (
    <>
      {/* Desktop Navigation */}
      <header className="hidden lg:block bg-white/80 backdrop-blur-md border-b border-orange-200/50 sticky top-0 z-50">
      ...
      {/* Mobile Navigation */}
      <header className="lg:hidden bg-white/80 backdrop-blur-md border-b border-orange-200/50 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <Link to="/dashboard" className="flex items-center space-x-2">
              <div className="w-8 h-8 bg-gradient-to-r from-orange-500 to-green-500 rounded-full"></div>
              <h1 className="text-xl font-bold text-gray-800">SnackTrack</h1>
            </Link>
              ...
              <SheetContent side="right" className="w-80 bg-white/95 backdrop-blur-md">
                <div className="py-6">
                  <div className="flex items-center space-x-2 mb-8">
                    <div className="w-10 h-10 bg-gradient-to-r from-orange-500 to-green-500 rounded-full"></div>
                    <div>
                      <h2 className="text-lg font-bold text-gray-800">SnackTrack</h2>
      ...
      <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-orange-200/50 z-50">
